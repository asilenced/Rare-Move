module ItsRareL::MerkleProof {
    ...
    fun verify_test(creator: &signer) {
        ...
        debug::print(&root_hash);
        let root_hash_str = b"5ec1861c48518f41c3d4d037af879ff153a49ecd6d942796e8036ae485fcb167";
        debug::print(&root_hash_str);
        let outputs = vector[
